...
class DataValidation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, 
        ...
        """
        Initializes the DataValidation class with configuration and artifact objects.
    ...
    def detect_dataset_drift(self,base_df,current_df,threshold=0.05)->bool:
        try:
            ...
            logging.info("Detecting data drift using Kolmogorov-Smirnov test.")
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        """
        Validates the ingested data by checking for schema compliance and statistical tests.
        
        Returns:
            DataValidationArtifact: Artifact containing paths to valid and invalid data.
